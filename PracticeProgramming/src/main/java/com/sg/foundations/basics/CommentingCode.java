...
public class CommentingCode {
    public static void main(String[] args) {
        ...
        // anything after // is considerd a comment
        ...
        /* 
            This is an example of a multi-line comment which is useuful if
        you want to comment out multiple lines of code quickly.
        Console.WriteLine(Java ignores everything inside the comment markets.");
        */
    }
